...
class ArrTest extends TestCase
{
    ...
    {
        $array = Arr::add(['name' => 'PidanPHP'], 'price', 100);
        $this->assertSame(['name' => 'PidanPHP', 'price' => 100], $array);
    }
    ...
    {
        list($keys, $values) = Arr::divide(['name' => 'PidanPHP']);
        $this->assertSame(['name'], $keys);
        $this->assertSame(['PidanPHP'], $values);
    }
    ...
    {
        $array = ['name' => 'PidanPHP', 'price' => 100];
        $array = Arr::except($array, ['price']);
        $this->assertSame(['name' => 'PidanPHP'], $array);
    }
    ...
    {
        $array = ['name' => 'PidanPHP', 'price' => 100, 'orders' => 10];
    ...
    public function testForget()
    {
        ...
        // Only works on first level keys
        $array = ['i@example.com' => 'Joe', 'i@pidanphp.com' => 'Jane'];
        Arr::forget($array, 'i@example.com');
        $this->assertSame(['i@pidanphp.com' => 'Jane'], $array);
        // Does not work for nested keys
